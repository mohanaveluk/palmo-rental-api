...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Return product by id', type: product_entity_1.Product }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Product deleted successfully', type: product_entity_1.Product }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
